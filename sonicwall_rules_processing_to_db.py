...
conn = sqlite3.connect('/Users/chris/Library/CloudStorage/OneDrive-Personal/code_data/sonicwall/sonicwall_test.db')

# Need to convert large 64int to string due to SQLLite limitations
